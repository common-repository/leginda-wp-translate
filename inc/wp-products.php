...
/**
 * Page for managing translations of pages
 * 
 */
function leginda_wp_products()
{
    ...
    // The Query
    $query1 = new WP_Query( array( 'post_type' => 'product', 'posts_per_page' => -1  )  );
            ...
            <tr>
                ...
                <td>
                    <a class="leginda_wp_down" id="<?php echo $id; ?>" href="<?php echo admin_url( 'admin.php?page=leginda_wp_posts' ); ?>&leginda_wp_submitted=<?php echo $id; ?>">
                        <span class='dashicons dashicons-arrow-down-alt'></span> <?php echo  __('Export and Download', 'leginda_wp'); ?>
                    </a>
                </td>
                <td>
